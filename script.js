(function(){
  ...
  var ARMY_DATA = [
    ...
    {faction:'chaos', label:'CHAOS DAEMONS', title:'Be\'lakor, the Dark Master', painter:'Devin Du Plessis', img:'assets/belakor.webp', color:'#6a2d6e', desc:'Be\'lakor, known as the Dark Master, was the first Daemon Prince ever created by the four Chaos Gods — Khorne, Tzeentch, Nurgle and Slaanesh — who raised him to immense power as their ultimate champion. His ambition and hunger for independence made the gods fear him, so they cursed him never to openly rule, forcing him instead to manipulate events from the shadows. Devin\'s version pairs violet-to-amber blended wings with a molten lava base and a spectral green blade.'},
